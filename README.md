...
- **一部の特性はダメージ計算に反映されません**: 計算エンジンが未対応の特性があり、効果がダメージ計算結果に含まれません。get_ability_info で効果を確認したうえで結果を解釈してください。
- **一部の持ち物はダメージ計算に反映されません**: 計算エンジンが未対応の持ち物があります。get_item_info で効果を確認したうえで結果を解釈してください。
